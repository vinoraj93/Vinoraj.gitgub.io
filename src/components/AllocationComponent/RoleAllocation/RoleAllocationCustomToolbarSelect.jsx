...
import AddHRAllocationForm from "./AddRoleAllocationForm";
...
export default function RoleAllocationCustomToolbarSelect() {
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Do you want to deallocate Role from the selected employee(s)?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
