...
function createData(privileges, pm, dev, qa, tl, qal) {
  return { privileges, pm, dev, qa, tl, qal };
}
...
const rows = [
  ...
  createData("Add Project"),
  createData("Edit Project"),
  createData("Manage Project"),
  createData("HR Manage Allocation"),
  createData("HR Edit Allocation"),
  createData("HR Add Allocation"),
  createData("PM Manage Allocation"),
  createData("PM Edit Allocation"),
  createData("PM Add Allocation"),
  createData("Add Employee"),
  createData("Edit Employee"),
  createData("Manage Employee"),
  createData("Company Dashboard"),
  createData("PM Dashboard"),
  createData("QA Dashboard"),
  createData("Developer Dashboard"),
  createData("PM Privilage"),
